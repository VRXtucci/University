...
$query = "SELECT * FROM usuarios WHERE roles_id = 2";
...
<body class="flex w-screen h-screen">
    ...
    <div id="modalAgregar" class=" z-10 fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden">
        <div class="bg-white p-8 rounded-lg shadow-lg w-96">
            <form id="maestroForm" action="../../controllers/AdminCreaterController.php" method="post">
                <header>
                    <h1 class="text-2xl font-bold mb-4">Agregar Maestro</h1>
                </header>
                <main>
                    ...
                    <label for="ClaseAsignada" class="block font-semibold">Clase Asignada</label>
                    <select id="ClaseAsignada" name="ClaseAsignada" class="w-full border border-gray-300 rounded-md p-2 mb-4">
    ...
    <div id="modalEditar" class="z-10 fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden">
        <div class="bg-white p-8 rounded-lg shadow-lg w-96">
            <form id="editarMaestroForm" method="post" action="../../controllers/AdminCreaterController.php">
                <header>
                    <h1 class="text-2xl font-bold mb-4">Editar Maestro</h1>
                </header>
                <main>
                    <label for="EditarNombre" class="block font-semibold">Nombre</label>
                    <input type="text" id="EditarNombre" name="EditarNombre" class="w-full border border-gray-300 rounded-md p-2 mb-4">

                    <label for="EditarEmail" class="block font-semibold">Correo Electrónico</label>
                    <input type="email" id="EditarEmail" name="EditarEmail" class="w-full border border-gray-300 rounded-md p-2 mb-4">

                    <label for="EditarDireccion" class="block font-semibold">Dirección</label>
                    <input type="text" id="EditarDireccion" name="EditarDireccion" class="w-full border border-gray-300 rounded-md p-2 mb-4">

                    <label for="EditarFechaNacimiento" class="block font-semibold">Fecha de Nacimiento</label>
                    <input type="date" id="EditarFechaNacimiento" name="EditarFechaNacimiento" class="w-full border border-gray-300 rounded-md p-2 mb-4">

                    <label for="EditarClaseAsignada" class="block font-semibold">Clase Asignada</label>
                    <select id="EditarClaseAsignada" name="EditarClaseAsignada" class="w-full border border-gray-300 rounded-md p-2 mb-4">
                        <option value="" disabled selected>Selecciona Clase</option>
                        <!-- Agrega más opciones aquí si es necesario -->
                    </select>
                </main>
                <footer class="mt-4">
                    <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded-md mr-2">Guardar Cambios</button>
                    <button id="closeModalEditar" class="bg-gray-400 text-white px-4 py-2 rounded-md">Cerrar</button>
                </footer>
            </form>
        </div>
    </div>
    ...
    <aside class="bg-[#353a40] h-screen flex flex-col w-2/12">
        <a href="./AdminDashboard.php" class="flex gap-2 items-center p-4 border-b-2 border-[#42474d]">
            <img href="./AdminDashboard.php" class="h-12 w-12 rounded-full" src="../../assets/logo.jpg" alt="logo">
        ...
        <div class="flex flex-col gap-6 p-4">
            <span class="text-[#c2c5cd] px-6">MENÚ ADMINISTRACIÓN</span>
    ...
    <section class="flex flex-col w-screen">
        ...
        <!-- aquí comienza el encabezado de la tabla  -->
        <main>
            ...
            <div class=" ring-1 ring-[#c2c5cd] mx-4">
                <section class="flex flex-col">
                    <div class="flex justify-between">
                        <h2 class="text-xl pl-2 py-2 border-2 border-white border-b-[#c2c5cd]">Información de maestros
                        </h2>
                        <button id="openModal" class="bg-blue-500 text-white mr-4 mt-4 rounded-md px-2 py-1">Agregar Maestro</button>
                    </div>
                    ...
                    <div class="flex justify-between py-4">
                        <div class="flex ml-4">
                            ...
                            <select class="bg-[#6c747e] rounded-r-md">Column Visibility</select>
                        </div>
                        <div class="mr-4">
                            <label>Search</label>
